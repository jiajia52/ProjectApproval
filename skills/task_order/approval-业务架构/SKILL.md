---
skill_id: approval-业务架构
name: approval-业务架构-业务架构
description: 项目立项审批规则，聚合“业务架构”进程tab页下全部评审点。用于项目立项审批、远程项目审批和大模型审批建议生成时，对该tab页相关内容进行统一复核。
project_type: ALL
...
- builtin:任务单规则.xlsx
rules:
- 业务单元清单 / 业务对象数字化: 具备业务对象
- 业务单元清单 / 业务规则数字化: 具备业务单元
- 业务单元清单 / 业务过程数字化: 具备业务过程
- 审批节点 / 审批节点消除情况: 具备功能描述
- 审批节点 / 实现自动化/智能化审批节点情况: 具备功能描述
enabled: true
---
# Skill: approval-业务架构-业务架构
...
## 审批目标
- 对“业务架构”tab页下的全部评审点、评审内容和规则进行一次性复核。
